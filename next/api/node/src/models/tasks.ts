...
export const tasksModel = {
  findFirst<T extends Prisma.TaskFindFirstArgs>(args: Prisma.SelectSubset<T, Prisma.TaskFindFirstArgs>) {
  ...
  create<T extends Prisma.TaskCreateArgs>(args: Prisma.SelectSubset<T, Prisma.TaskCreateArgs>) {
    return prisma.task.create(args);
  },

  update<T extends Prisma.TaskUpdateArgs>(args: Prisma.SelectSubset<T, Prisma.TaskUpdateArgs>) {
