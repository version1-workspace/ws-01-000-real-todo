...
router.patch('/users/projects/:slug/archive', asyncHandler(projectsController.archive));
router.patch('/users/projects/:slug/reopen', asyncHandler(projectsController.reopen));

router.get('/users/tags', asyncHandler(tagsController.list));

router.get('/projects/:slug/milestones', asyncHandler(milestonesController.list));
router.put(
